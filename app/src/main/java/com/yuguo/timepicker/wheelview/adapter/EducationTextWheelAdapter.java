...
public class EducationTextWheelAdapter extends AbstractWheelTextAdapter {
    private List<WorkStutasBean> list;
    private Context mContext;
    private String label = "";

    public EducationTextWheelAdapter(Context context, List<WorkStutasBean> stringList) {
        super(context);
